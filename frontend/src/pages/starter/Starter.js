    ...
    <div className={classes.root}>
      <div className={classes.starterBlock}>
        ...
        <h3 className='my-3 align-self-center'>
          Welcome to your AIDocs-Admin application!
        </h3>
        <p>
          This is a React/Node.JS app generated by the{' '}
          <a href='https://infinov.com/generator'>
            infinov Web App Generator
          </a>
          . For guides and documentation please check your local README.md and{' '}
          <a href='https://infinov.com/documentation'>
            infinov documentation
          </a>
          .
        </p>
        ...
        <div className={classes.links}>
          ...
          <div>
            💫{' '}
            <a target={"_blank"} href="https://infinov.com/forum/">
              infinov Forum
            </a>
          </div>
          <div>
