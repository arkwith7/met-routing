...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/doc_master/autocomplete`, { params });
  return response.data;
}

const Doc_masterSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.doc_master.hasPermissionToCreate
});
